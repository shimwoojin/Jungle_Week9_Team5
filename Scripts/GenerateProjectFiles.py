...
ADDITIONAL_DEPENDENCIES = ["rmlui.lib", "rmlui_debugger.lib"]
...
def generate_vcxproj(files: dict[str, list[str]]):
    ...
    for cfg, plat in CONFIGURATIONS:
        ...
        if ADDITIONAL_DEPENDENCIES and is_x64:
            ET.SubElement(link, "AdditionalDependencies").text = ";".join(ADDITIONAL_DEPENDENCIES) + ";%(AdditionalDependencies)"
